...
const r = () => {
  ...
  , i = n => {
    ...
    if (e)
        return e;
    if (e = o(n.name, n.icon, n.mode, n.ios, n.md),
    e)
        return s(e);
    if (n.icon) {
        if (e = f(n.icon),
  ...
  , o = (n, e, r, t, i) => (r = "ios" === (r && l(r)) ? "ios" : "md",
t && "ios" === r ? n = l(t) : i && "md" === r ? n = l(i) : (n || !e || u(e) || (n = e),
a(n) && (n = l(n))),
a(n) && "" !== n.trim() ? "" !== n.replace(/[a-z]|-|\d/gi, "") ? null : n : null)
  , f = n => a(n) && (n = n.trim(),
u(n)) ? n : null
